...
class FindPetViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    private let nameTextField = FindPetViewController.createTextField(placeholder: "Pet Name")
    private let ageTextField = FindPetViewController.createTextField(placeholder: "Age", keyboardType: .numberPad)
    private let breedTextField = FindPetViewController.createTextField(placeholder: "Breed")
    private let categoryTextField = FindPetViewController.createTextField(placeholder: "Category (Dog, Cat)")
    var onPetAdded: (() -> Void)?
