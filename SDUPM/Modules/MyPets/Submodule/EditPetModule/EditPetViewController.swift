...
class EditPetViewController: UIViewController, UITextViewDelegate {
    ...
    private let nameTextField = EditPetViewController.createTextField(placeholder: "Pet Name")
    private let categoryTextField = EditPetViewController.createTextField(placeholder: "Category (Dog, Cat)")
    private let ageTextField = EditPetViewController.createTextField(placeholder: "Age", keyboardType: .decimalPad)
    private let breedTextField = EditPetViewController.createTextField(placeholder: "Breed")
    private let colorTextField = EditPetViewController.createTextField(placeholder: "Color")
    private let genderTextField = EditPetViewController.createTextField(placeholder: "Gender")
    ...
    var item: MyPetModel {
        didSet {
            ...
            categoryTextField.text = item.species
            ageTextField.text = item.age
            breedTextField.text = item.breed
            colorTextField.text = item.color
            genderTextField.text = item.gender
            descriptionTextView.text = item.description
        }
    }
    
    init(item: MyPetModel) {
        selectedImages = item.images
        nameTextField.text = item.name
        categoryTextField.text = item.species
        ageTextField.text = item.age
...
extension EditPetViewController: UICollectionViewDataSource, UICollectionViewDelegate {
