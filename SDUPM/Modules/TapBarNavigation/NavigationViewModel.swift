...
class NavigationViewModel: UITabBarController {
    ...
    let vc4 = ChatListViewController()
    let vc5 = ProfileView()
    ...
    func setupUI() {
        ...
        [vc1, vc2, vc3, vc4, vc5].forEach({$0.navigationItem.largeTitleDisplayMode = .always})
        ...
        nav4.tabBarItem = UITabBarItem(title: "Chats", image: UIImage(systemName: "message"), tag: 3)
